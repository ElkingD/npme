  ...
  const size_t blockSize)
{
  ...
  size_t k;
  #pragma omp parallel shared(V1, Q1, coord, k0, nBlock, nPair, nBlock, remain, vecOption, blockSize) private(k) default(none) num_threads(nProc)
  {
  ...
  const size_t blockSize)
{
  ...
  size_t k;
  #pragma omp parallel shared(V, charge, coord, cluster, Rdir, Nder, a, b, k0, nCluster, vecOption, blockSize) private(k) default(none) num_threads(nProc)
  {
