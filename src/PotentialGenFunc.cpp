  ...
  const size_t blockSize)
{
  ...
  size_t k;
  #pragma omp parallel shared(V, charge, coord, cluster, func, nCluster, vecOption, blockSize) private(k) default(none) num_threads(nProc)
  {
  ...
  const size_t blockSize)
{
  ...
  size_t k;
  #pragma omp parallel shared(V1, Q1, coord, nBlock, func, nPair, nBlock, remain, vecOption, blockSize) private(k) default(none) num_threads(nProc)
  {
  ...
  const size_t blockSize)
{
  ...
  size_t k;
  #pragma omp parallel shared(V1, Q1, coord, nBlock, func, nCharge, nPair, nBlock, remain, vecOption, blockSize) private(k) default(none) num_threads(nProc)
  {
